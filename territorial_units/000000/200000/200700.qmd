...
[powiatu ostrołęckiego](../140000/141500.qmd), [powiatu ostrowskiego](../140000/141600.qmd), [powiatu białostockiego](../200000/200200.qmd), [powiatu grajewskiego](../200000/200400.qmd), [powiatu kolneńskiego](../200000/200600.qmd), [powiatu monieckiego](../200000/200800.qmd), [powiatu zambrowskiego](../200000/201400.qmd), [Łomży](../200000/206200.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/200700-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "200700",
                                  JST: "Powiat łomżyński",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/200700-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/200700-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/200700-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/200700-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/200700-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/200700-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie łomżyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:10,%22districtId%22:222,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
