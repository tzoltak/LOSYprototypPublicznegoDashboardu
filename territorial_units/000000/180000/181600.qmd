...
[powiatu brzozowskiego](../180000/180200.qmd), [powiatu kolbuszowskiego](../180000/180600.qmd), [powiatu leżajskiego](../180000/180800.qmd), [powiatu łańcuckiego](../180000/181000.qmd), [powiatu niżańskiego](../180000/181200.qmd), [powiatu przemyskiego](../180000/181300.qmd), [powiatu przeworskiego](../180000/181400.qmd), [powiatu ropczycko-sędziszowskiego](../180000/181500.qmd), [powiatu strzyżowskiego](../180000/181900.qmd), [Rzeszowa](../180000/186300.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/181600-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "181600",
                                  JST: "Powiat rzeszowski",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/181600-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/181600-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/181600-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/181600-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/181600-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/181600-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie rzeszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:206,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
