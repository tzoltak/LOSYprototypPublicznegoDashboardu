...
[powiatu mieleckiego](../180000/181100.qmd), [powiatu niżańskiego](../180000/181200.qmd), [powiatu ropczycko-sędziszowskiego](../180000/181500.qmd), [powiatu rzeszowskiego](../180000/181600.qmd), [powiatu stalowowolskiego](../180000/181800.qmd), [powiatu tarnobrzeskiego](../180000/182000.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/180600-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "180600",
                                  JST: "Powiat kolbuszowski",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/180600-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/180600-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/180600-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/180600-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/180600-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/180600-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie kolbuszowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:9,%22districtId%22:196,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
