---
title: "Powiat golubsko-dobrzyński"
format: html
---
...
[powiatu brodnickiego](../040000/040200.qmd), [powiatu lipnowskiego](../040000/040800.qmd), [powiatu rypińskiego](../040000/041200.qmd), [powiatu toruńskiego](../040000/041500.qmd), [powiatu wąbrzeskiego](../040000/041700.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/040500-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "040500",
                                  JST: "Powiat golubsko-dobrzyński",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/040500-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/040500-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/040500-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/040500-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/040500-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/040500-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie golubsko-dobrzyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:34,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
