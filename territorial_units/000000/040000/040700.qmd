...
[powiatu aleksandrowskiego](../040000/040100.qmd), [powiatu bydgoskiego](../040000/040300.qmd), [powiatu mogileńskiego](../040000/040900.qmd), [powiatu radziejowskiego](../040000/041100.qmd), [powiatu toruńskiego](../040000/041500.qmd), [powiatu żnińskiego](../040000/041900.qmd), [powiatu konińskiego](../300000/301000.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/040700-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "040700",
                                  JST: "Powiat inowrocławski",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/040700-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/040700-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/040700-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/040700-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/040700-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/040700-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie inowrocławskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:36,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
