...
[powiatu aleksandrowskiego](../040000/040100.qmd), [powiatu golubsko-dobrzyńskiego](../040000/040500.qmd), [powiatu rypińskiego](../040000/041200.qmd), [powiatu toruńskiego](../040000/041500.qmd), [powiatu włocławskiego](../040000/041800.qmd), [Włocławka](../040000/046400.qmd), [powiatu płockiego](../140000/141900.qmd), [powiatu sierpeckiego](../140000/142700.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/040800-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "040800",
                                  JST: "Powiat lipnowski",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/040800-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/040800-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/040800-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/040800-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/040800-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/040800-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie lipnowskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:2,%22districtId%22:37,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
