...
[powiatu sępoleńskiego](../040000/041300.qmd), [powiatu tucholskiego](../040000/041600.qmd), [powiatu bytowskiego](../220000/220100.qmd), [powiatu człuchowskiego](../220000/220300.qmd), [powiatu kościerskiego](../220000/220600.qmd), [powiatu starogardzkiego](../220000/221300.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/220200-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "220200",
                                  JST: "Powiat chojnicki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/220200-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/220200-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/220200-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/220200-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/220200-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/220200-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie chojnickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:11,%22districtId%22:234,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
