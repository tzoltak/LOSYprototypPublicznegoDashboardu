...
[powiatu jarocińskiego](../300000/300600.qmd), [powiatu kaliskiego](../300000/300700.qmd), [powiatu konińskiego](../300000/301000.qmd), [powiatu krotoszyńskiego](../300000/301200.qmd), [powiatu ostrowskiego](../300000/301700.qmd), [powiatu słupeckiego](../300000/302300.qmd), [powiatu wrzesińskiego](../300000/303000.qmd), [Kalisza](../300000/306100.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/302000-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "302000",
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/302000-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/302000-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/302000-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/302000-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/302000-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/302000-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie pleszewskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:343,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
