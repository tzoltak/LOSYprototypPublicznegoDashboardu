...
[powiatu nowosolskiego](../080000/080400.qmd), [powiatu zielonogórskiego](../080000/080900.qmd), [powiatu wschowskiego](../080000/081200.qmd), [powiatu grodziskiego](../300000/300500.qmd), [powiatu kościańskiego](../300000/301100.qmd), [powiatu leszczyńskiego](../300000/301300.qmd), [powiatu nowotomyskiego](../300000/301500.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/302900-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "302900",
                                  JST: "Powiat wolsztyński",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/302900-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/302900-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/302900-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/302900-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/302900-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/302900-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie wolsztyńskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:352,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
