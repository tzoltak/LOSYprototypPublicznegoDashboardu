---
title: "Powiat czarnkowsko-trzcianecki"
format: html
---
...
import { set_diff, sort_overall_first, sort_numeric, download_csv, sequence } from '../../../resources/functions.js'
```

**Przejdź do sąsiednich:**

[powiatu strzelecko-drezdeneckiego](../080000/080600.qmd), [powiatu chodzieskiego](../300000/300100.qmd), [powiatu międzychodzkiego](../300000/301400.qmd), [powiatu obornickiego](../300000/301600.qmd), [powiatu pilskiego](../300000/301900.qmd), [powiatu szamotulskiego](../300000/302400.qmd), [powiatu wałeckiego](../320000/321700.qmd)
...
viewof status_rok_abs = Inputs.checkbox(
          ...
          .map( (g) => g.rok_abs )),
  {
    ...
    value: [d3.max(status.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof status_nazwa_zaw = Inputs.select(
  new Set(status
          .filter( (g) => status_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
viewof status_czas = Inputs.radio(
          ...
          .map( (g) => g.czas )),
  {
    ...
    value: d3.min(status.map( (g) => g.czas )),
    valueof: (v) => v,
    format: (v) => v,
    sort: sort_numeric
  }
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/300200-status.json").json()
```
...
statusF = status
  .filter( (g) => status_typ_szk.includes(g.typ_szk) )
  .filter( (g) => status_rok_abs.includes(g.rok_abs) )
  .filter( (g) => status_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => status_plec.includes(g.plec) )
  .filter( (g) => status_nazwa_zaw.includes(g.nazwa_zaw) )
  .filter( (g) => status_czas.includes(g.czas) )
statusC = [].concat(
  ...statusF
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "300200",
                                  JST: "Powiat czarnkowsko-trzcianecki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
viewof bezrobocie_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(bezrobocie.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof bezrobocie_nazwa_zaw = Inputs.select(
  new Set(bezrobocie
          .filter( (g) => bezrobocie_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
viewof bezrobocie_czas = Inputs.radio(
  ...
  {
    label: "Miesiąc od ukończenia szkoły:",
    value: d3.min(bezrobocie.map( (g) => g.czas )),
    valueof: (v) => v,
    format: (v) => v,
    sort: sort_numeric
  }
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/300200-bezrobocie.json").json()
```
...
bezrobocieF = bezrobocie
  .filter( (g) => bezrobocie_typ_szk.includes(g.typ_szk) )
  .filter( (g) => bezrobocie_rok_abs.includes(g.rok_abs) )
  .filter( (g) => bezrobocie_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => bezrobocie_plec.includes(g.plec) )
  .filter( (g) => bezrobocie_nazwa_zaw.includes(g.nazwa_zaw) )
  .filter( (g) => bezrobocie_czas.includes(g.czas) )
bezrobocieC = [].concat(
  ...bezrobocieF
  .filter( (g) => Object.hasOwn(g.wartosc, "w") )
  .map( (g) => g.wartosc.w.map( (x) => Object.assign({}, { rok_abs: g.rok_abs }, x) ) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
viewof sr_wynagr_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(sr_wynagr.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof sr_wynagr_nazwa_zaw = Inputs.select(
  new Set(sr_wynagr
          .filter( (g) => sr_wynagr_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/300200-sr_wynagr.json").json()
```
...
sr_wynagrF = sr_wynagr
  .filter( (g) => sr_wynagr_typ_szk.includes(g.typ_szk) )
  .filter( (g) => sr_wynagr_rok_abs.includes(g.rok_abs) )
  .filter( (g) => sr_wynagr_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => sr_wynagr_plec.includes(g.plec) )
  .filter( (g) => sr_wynagr_nazwa_zaw.includes(g.nazwa_zaw) )
sr_wynagrC = [].concat(
  ...sr_wynagrF
  .filter( (g) => Object.hasOwn(g.wartosc, "w") )
  .map( (g) => g.wartosc.w.map( (x) => Object.assign({}, { rok_abs: g.rok_abs }, x) ) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
viewof matura_zdana_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(matura_zdana.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof matura_zdana_nazwa_zaw = Inputs.select(
  new Set(matura_zdana
          .filter( (g) => matura_zdana_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/300200-matura_zdana.json").json()
```
...
matura_zdanaF = matura_zdana
  .filter( (g) => matura_zdana_typ_szk.includes(g.typ_szk) )
  .filter( (g) => matura_zdana_rok_abs.includes(g.rok_abs) )
  .filter( (g) => matura_zdana_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => matura_zdana_plec.includes(g.plec) )
  .filter( (g) => matura_zdana_nazwa_zaw.includes(g.nazwa_zaw) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
viewof dyplom_zaw_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(dyplom_zaw.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof dyplom_zaw_nazwa_zaw = Inputs.select(
  new Set(dyplom_zaw
          .filter( (g) => dyplom_zaw_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/300200-dyplom_zaw.json").json()
```
...
dyplom_zawF = dyplom_zaw
  .filter( (g) => dyplom_zaw_typ_szk.includes(g.typ_szk) )
  .filter( (g) => dyplom_zaw_rok_abs.includes(g.rok_abs) )
  .filter( (g) => dyplom_zaw_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => dyplom_zaw_plec.includes(g.plec) )
  .filter( (g) => dyplom_zaw_nazwa_zaw.includes(g.nazwa_zaw) )
dyplom_zawC = [].concat(
  ...dyplom_zawF
  .filter( (g) => Object.hasOwn(g.wartosc, "w") )
  .map( (g) => g.wartosc.w.map( (x) => Object.assign({}, { rok_abs: g.rok_abs }, x) ) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
viewof typ_szk_kont_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(typ_szk_kont.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof typ_szk_kont_nazwa_zaw = Inputs.select(
  new Set(typ_szk_kont
          .filter( (g) => typ_szk_kont_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
viewof typ_szk_kont_czas = Inputs.radio(
  ...
  {
    label: "Miesiąc od ukończenia szkoły:",
    value: d3.min(typ_szk_kont.map( (g) => g.czas )),
    valueof: (v) => v,
    format: (v) => v,
    sort: sort_numeric
  }
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/300200-typ_szk_kont.json").json()
```
...
typ_szk_kontF = typ_szk_kont
  .filter( (g) => typ_szk_kont_typ_szk.includes(g.typ_szk) )
  .filter( (g) => typ_szk_kont_rok_abs.includes(g.rok_abs) )
  .filter( (g) => typ_szk_kont_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => typ_szk_kont_plec.includes(g.plec) )
  .filter( (g) => typ_szk_kont_nazwa_zaw.includes(g.nazwa_zaw) )
  .filter( (g) => typ_szk_kont_czas.includes(g.czas) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
viewof dyscyplina_kont_rok_abs = Inputs.checkbox(
  ...
  {
    label: "Rok ukończenia szkoły:",
    value: [d3.max(dyscyplina_kont.map( (g) => g.rok_abs ))],
    valueof: (v) => v,
    format: (v) => v,
    sort: "descending"
  }
...
viewof dyscyplina_kont_nazwa_zaw = Inputs.select(
  new Set(dyscyplina_kont
          .filter( (g) => dyscyplina_kont_typ_szk.includes(g.typ_szk) )
          .map( (g) => g.nazwa_zaw )),
  {
    label: "Zawód:",
    value: "Ogółem",
...
viewof dyscyplina_kont_czas = Inputs.radio(
  ...
  {
    label: "Miesiąc od ukończenia szkoły:",
    value: d3.min(dyscyplina_kont.map( (g) => g.czas )),
    valueof: (v) => v,
    format: (v) => v,
    sort: sort_numeric
  }
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/300200-dyscyplina_kont.json").json()
```
...
dyscyplina_kontF = dyscyplina_kont
  .filter( (g) => dyscyplina_kont_typ_szk.includes(g.typ_szk) )
  .filter( (g) => dyscyplina_kont_rok_abs.includes(g.rok_abs) )
  .filter( (g) => dyscyplina_kont_szk_specjalna.includes(g.szk_specjalna) )
  .filter( (g) => dyscyplina_kont_plec.includes(g.plec) )
  .filter( (g) => dyscyplina_kont_nazwa_zaw.includes(g.nazwa_zaw) )
  .filter( (g) => dyscyplina_kont_czas.includes(g.czas) )
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie czarnkowsko-trzcianeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:15,%22districtId%22:325,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
