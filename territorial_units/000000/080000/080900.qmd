...
[powiatu krośnieńskiego](../080000/080200.qmd), [powiatu nowosolskiego](../080000/080400.qmd), [powiatu świebodzińskiego](../080000/080800.qmd), [powiatu żagańskiego](../080000/081000.qmd), [powiatu żarskiego](../080000/081100.qmd), [Zielonej Góry](../080000/086200.qmd), [powiatu nowotomyskiego](../300000/301500.qmd), [powiatu wolsztyńskiego](../300000/302900.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/080900-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "080900",
                                  JST: "Powiat zielonogórski",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/080900-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/080900-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/080900-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/080900-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/080900-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/080900-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie zielonogórskim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:85,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
