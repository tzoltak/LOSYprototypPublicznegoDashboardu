---
title: "Powiat strzelecko-drezdenecki"
format: html
---
...
[powiatu gorzowskiego](../080000/080100.qmd), [powiatu międzyrzeckiego](../080000/080300.qmd), [powiatu czarnkowsko-trzcianeckiego](../300000/300200.qmd), [powiatu międzychodzkiego](../300000/301400.qmd), [powiatu choszczeńskiego](../320000/320200.qmd), [powiatu myśliborskiego](../320000/321000.qmd), [powiatu wałeckiego](../320000/321700.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/080600-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "080600",
                                  JST: "Powiat strzelecko-drezdenecki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/080600-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/080600-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/080600-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/080600-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/080600-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/080600-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie strzelecko-drezdeneckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:82,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
