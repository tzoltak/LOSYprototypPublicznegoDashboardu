...
[powiatu gorzowskiego](../080000/080100.qmd), [powiatu strzelecko-drezdeneckiego](../080000/080600.qmd), [powiatu sulęcińskiego](../080000/080700.qmd), [powiatu świebodzińskiego](../080000/080800.qmd), [powiatu międzychodzkiego](../300000/301400.qmd), [powiatu nowotomyskiego](../300000/301500.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/080300-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "080300",
                                  JST: "Powiat międzyrzecki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/080300-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/080300-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/080300-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/080300-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/080300-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/080300-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie międzyrzeckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:4,%22districtId%22:79,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
