...
[powiatu łowickiego](../100000/100500.qmd), [powiatu rawskiego](../100000/101300.qmd), [powiatu tomaszowskiego](../100000/101600.qmd), [powiatu brzezińskiego](../100000/102100.qmd), [Skierniewic](../100000/106300.qmd), [powiatu sochaczewskiego](../140000/142800.qmd), [powiatu żyrardowskiego](../140000/143800.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/101500-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "101500",
                                  JST: "Powiat skierniewicki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/101500-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/101500-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/101500-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/101500-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/101500-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/101500-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie skierniewickim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:5,%22districtId%22:105,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
