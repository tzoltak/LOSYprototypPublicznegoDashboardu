...
[powiatu choszczeńskiego](../320000/320200.qmd), [powiatu drawskiego](../320000/320300.qmd), [powiatu goleniowskiego](../320000/320400.qmd), [powiatu gryfińskiego](../320000/320600.qmd), [powiatu myśliborskiego](../320000/321000.qmd), [powiatu pyrzyckiego](../320000/321200.qmd), [powiatu łobeskiego](../320000/321800.qmd), [Szczecina](../320000/326200.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/321400-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "321400",
                                  JST: "Powiat stargardzki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/321400-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/321400-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/321400-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/321400-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/321400-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/321400-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie stargardzkim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:16,%22districtId%22:372,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
