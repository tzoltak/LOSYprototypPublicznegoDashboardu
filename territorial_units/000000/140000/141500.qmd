...
[powiatu makowskiego](../140000/141100.qmd), [powiatu ostrowskiego](../140000/141600.qmd), [powiatu przasnyskiego](../140000/142200.qmd), [powiatu wyszkowskiego](../140000/143500.qmd), [Ostrołęki](../140000/146100.qmd), [powiatu kolneńskiego](../200000/200600.qmd), [powiatu łomżyńskiego](../200000/200700.qmd), [powiatu piskiego](../280000/281600.qmd), [powiatu szczycieńskiego](../280000/281700.qmd)
...
```{ojs}
//| echo: false
status = await FileAttachment("../../../data/141500-status.json").json()
```
...
statusD = [].concat(
  ...
  .map( (g) => g.wartosc.w.map(
    (x) => Object.assign({}, x, { TERYT: "141500",
                                  JST: "Powiat ostrołęcki",
                                  typ_szk: g.typ_szk,
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[status_typ_szk]}%7D", target="_blank">${status_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
bezrobocie = await FileAttachment("../../../data/141500-bezrobocie.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[bezrobocie_typ_szk]}%7D", target="_blank">${bezrobocie_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
sr_wynagr = await FileAttachment("../../../data/141500-sr_wynagr.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[sr_wynagr_typ_szk]}%7D", target="_blank">${sr_wynagr_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
matura_zdana = await FileAttachment("../../../data/141500-matura_zdana.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[matura_zdana_typ_szk]}%7D", target="_blank">${matura_zdana_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyplom_zaw = await FileAttachment("../../../data/141500-dyplom_zaw.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[dyplom_zaw_typ_szk]}%7D", target="_blank">${dyplom_zaw_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
typ_szk_kont = await FileAttachment("../../../data/141500-typ_szk_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[typ_szk_kont_typ_szk]}%7D", target="_blank">${typ_szk_kont_typ_szk}</a>`
```
...
```{ojs}
//| echo: false
dyscyplina_kont = await FileAttachment("../../../data/141500-dyscyplina_kont.json").json()
```
...
```{ojs}
//| echo: false
html`Sprawdź w Rejestrze Szkół i Placówek Oświatowych (RSPO), jakie szkoły wybranego typu funkcjonują w powiecie ostrołęckim: <a href="https://rspo.gov.pl/institutions?q=%7B%22stateId%22:7,%22districtId%22:151,${rspoSchoolTypes[dyscyplina_kont_typ_szk]}%7D", target="_blank">${dyscyplina_kont_typ_szk}</a>`
```
